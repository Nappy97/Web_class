...
//
//        System.out.println(">>> " + bookReviewInfoRepository.findAll());  // SELECT
//        
//        System.out.println("\n------------------------------------------------------------\n");
//    }
...
//       
//        bookRepository.save(book);  // INSERT, auto-generated id
...
//        bookReviewInfo.setReviewCount(2);
//        
//        bookReviewInfoRepository.save(bookReviewInfo);  // INSERT. auto-genered id
...
//
//       
//        // 특정 book review info 에서 (부모) book 의 정보 읽어오기
//        Long parentBookId = 
...
//	    book.setPublisherId(1L);
	...
	void crudTest3() {
	    ...
	    // Book 에서 BookReviewInfo 정보 가져오기
