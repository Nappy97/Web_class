...
public class DIMain05 implements CommandLineRunner {
	...
	public DIMain05(@Qualifier("Park") Student stu1, @Qualifier("Hong") Student stu2) {
	...
	@Autowired	// setter 에 붙은 @Autowired
	@Qualifier("ko")	// @Qualifier 가 @Pirmary 보다 우선 적용
	public void setMsg2(MessageBean msg) {
		this.msg2 = msg;
	}
	
	// ※ field injection 보다는 setter injection 추천
