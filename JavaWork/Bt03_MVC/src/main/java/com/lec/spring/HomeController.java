...
@Controller // Spring MVC 에서 Controllerr 역확을 하는 클래스로 컨테이너에 생성
public class HomeController {
	...
	@RequestMapping("/") // "/" 라는 url 로 request 가 오면 아래 메소드라 처리(handle)한다
	public String now(Model model) { // Model : 데이터를 싫어나르는 객체, View 까지 전달
	...
	public String home(Model model) {
		...
		return "aaa/my";
		// "/WEB-INF/views/" + "aaa/my" + ".jsp" => /WEB-INF/views/aaa/my.jsp
	}
	...
	public String aaabbb(Model model) {
		...
		// "/WEB-INF/views/" + "aaa/bbb/title" + ".jsp" => /WEB-INF/views/aaa/bbb/title.jsp
	}
