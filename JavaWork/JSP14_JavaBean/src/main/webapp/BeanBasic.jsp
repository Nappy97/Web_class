...
<body>
	...
	<%-- 다음과 같은 일을 수행한다.
	 ...
	 <jsp:setProperty property="weight" name="person1" value="남"/>
	...
	<%-- 다음과 같은 일을 수행한다
	 ...
	 성별: <jsp:getProperty property="gender" name="person4"/><br>	 
	  --%>
	  이름: <%= person4.getName() %><br>
	  나이: <%= person4.getAge() %><br>
	 아이디: <%= person4.getId() %><br>
	 성별: <%= person4.getGender() %><br>
	 
	 
<%--	 <h3>student1</h3>
	 <jsp:getProperty property="name" name="student1"/><br>
	 <jsp:getProperty property="age" name="student1"/><br>
	 <jsp:getProperty property="grade" name="student1"/><br>
	 <jsp:getProperty property="gender" name="student1"/><br>
	 --%>
